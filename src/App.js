...
// const rNumber = Math.floor(Math.random() * noOfImages)
const forState = {
...
class App extends Component {
  ...
  onClickMatch = url => {
    ...
    if (randomImageUrl === url) {
      ...
      const noOf = imagesList.length
      const ramNumber = Math.floor(Math.random() * noOf)
      this.setState({randomNumber: ramNumber})
    } else {
      this.setState({isGameOver: true})
      clearInterval(this.timerID)
    }
  ...
  render() {
    const {activeTab, timer, randomNumber, score, isGameOver} = this.state
      ...
      <div className="bg-container">
        <div className="top-container">
          ...
          <div className="top-score-container">
            <p className="score">
              Score: <span className="score-s">{score}</span>
            </p>
            ...
            <div className="timer-container">
              <img
                ...
                className="timer-img"
              />
              <p className="timer-s">{timer} sec</p>
            </div>
          </div>
        </div>
        {isGameOver ? (
          ...
          <div className="body-container">
            <div className="main-image-container">
              <img src={randomImageUrl} alt="match" className="main-image" />
            </div>
